...
class SettingsController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        return response()->json([
            ...
            'sync_exclude_categories' => $this->settingsService->getArray('sync_exclude_categories', ['Sandboxed']),
            ...
            'entry_exclude_categories' => $this->settingsService->getArray('entry_exclude_categories', ['Archived']),
